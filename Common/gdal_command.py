...
if __name__ == "__main__":
    print(gdalinfo(r"D:\projectdata\NICT\data\pythontest2\Kumamoto_20190307194908c.tif"))
    gdaltranslate_gcp(r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_trans_1.tif",
                      r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_base.tif",
                      [(0,0,130,40),(0,1199,140,40),(1199,0,130,30),(1199,1199,140,30)])
    gdalwarp(r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_warp_1.tif",
             r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_trans_1.tif")
    gdaltranslate_resolution(r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_res_1.tif",
                             r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_warp_1.tif",
                             0.1,0.1)
    gdaltranslate_resolution(r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_res_2.tif",
                             r"D:\projectdata\NICT\data\pythontest2\tmp_Kumamoto_warp_1.tif",
                             0.1,0.1, out_area=(131,35,135,30))
